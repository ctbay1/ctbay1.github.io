function first_game(){
    ...
    const game_grid        = document.getElementById('game_grid_1');
    const restart_button   = document.getElementById('restart_button_1');
    const hide_letters_but = document.getElementById('hide_letters');
    const letter_in_but    = document.getElementById('letter_in_button');

    const boxes       = document.getElementsByClassName('box_1');
    const box_nums    = 9;
    const box_letters = document.getElementsByClassName('box_letter_1');
